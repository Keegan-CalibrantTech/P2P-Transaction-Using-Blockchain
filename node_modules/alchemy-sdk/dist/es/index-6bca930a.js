    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield import('./alchemy-provider-faa5d8b1.js');
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield import('./alchemy-websocket-provider-48bbb0ed.js');
...
export { Alchemy as A, CustomNetworks as C, DEFAULT_ALCHEMY_API_KEY as D, EthersNetwork as E, IS_BROWSER as I, Network as N, RefreshState as R, TokenBalanceType as T, VERSION as V, Wallet as W, __awaiter as _, DEFAULT_NETWORK as a, getAlchemyWsUrl as b, Contract as c, ContractFactory as d, AssetTransfersCategory as e, fromHex as f, getAlchemyHttpUrl as g, AssetTransfersOrder as h, isHex as i, NftTokenType as j, NftExcludeFilters as k, logWarn as l, noop as n, setLogLevel as s, toHex as t };
//# sourceMappingURL=index-6bca930a.js.map
